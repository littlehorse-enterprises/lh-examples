...
public class EscalateCaseWorkflow {
    ...
    public void workflowSpec(WorkflowThread wf) {
        ...
        NodeOutput escalationTaskResult = wf.execute(
                        Constants.ESCALATE_CASE_TASK, caseId, customerEmail, reason, department, priority, agentNotes)
                .withRetries(5)
                .timeout(60);
        ...
        wf.execute(Constants.AUDIT_LOG_TASK, caseId, "Case escalated to " + department + " department")
                .withRetries(5);
    }

    public Workflow getWorkflow() {
        return Workflow.newWorkflow(Constants.ESCALATE_CASE_WORKFLOW, this::workflowSpec);
    }
}
